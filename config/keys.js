...
module.exports = {
  mongo_URI_AUTH: process.env.MONGO_URI_AUTH,
  mongo_URI_ROOM: process.env.MONGO_URI_ROOM,
  mongo_URI_MSG: process.env.MONGO_URI_MSG,
  mongo_URI_FILE: process.env.MONGO_URI_FILE,
